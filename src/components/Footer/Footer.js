        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="flex flex-col">
            ...
            <form className="flex flex-col sm:flex-row items-center">
              <input type="email" placeholder="Email address" className="flex-grow mb-2 sm:mb-0 sm:mr-2 py-2 px-3 rounded-md border border-gray-300 focus:outline-none" />
              <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded-md">Subscribe</button>
            </form>
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col items-center">
            <img src="https://media.istockphoto.com/id/1347332330/vector/pakistan-3d-rounded-country-flag-button-icon.jpg?s=1024x1024&w=is&k=20&c=YNOvlWIWqM_zALtt967u1XajryvpDH6uDZ933NR0KAI=" alt="Placeholder Image" className="w-24 h-24 rounded-full mx-auto mb-2" />
